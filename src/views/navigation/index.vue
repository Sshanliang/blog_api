...
{{this.classifyID}}
    ...
    <el-dialog
        ...
        <el-form ref="form" :model="form" :rules="rules">
            ...
            <el-form-item label="导航分类"  :label-width="formLabelWidth" prop="region">
            ...
            <el-form-item label="导航排序" :label-width="formLabelWidth" prop="sort">
    ...
    export default {
        data() {
            return {
                ...
                update:0,
                rules: {
                    name: { required: true, message: '请输导航栏',trigger:'blur' },
...
//            弹框数据获取
            MenuOneData(scope) {
                ...
                this.$api.get("menu/"+scope, null, (success) => {
                        this.listLoading = false
                        this.form=success
                        this.FormData.main = success.main2
